...
pg.typewrite("EMAIL PARA O INSTAGRAM", interval=0.35)
tab()
...
pg.typewrite("1990", interval=0.35) #OU COLOQUE O ANO DE SUA PREFERÊNCIA
pg.press('enter')
