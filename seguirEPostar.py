...
pg.typewrite("NOME DO USUÁRIO DO INSTAGRAM", interval=0.35)
...
pg.typewrite("NOME DA IMAGEM PARA COMPARTILHAR",interval=0.35)
pg.press("enter")
...
pg.typewrite("MENSAGEM DA POSTAGEM NO INSTAGRAM", interval=0.35)
